...
class ArgParser(object):
    def __init__(self):
        ...
        add_arg('--ed_date', type=str, help='Course end date. Currently support format:YYYY-MM-DD')
        ...
        # add_arg('--updateStudent', nargs='+', metavar='TEST', help='Update a student info', action="store_true")
